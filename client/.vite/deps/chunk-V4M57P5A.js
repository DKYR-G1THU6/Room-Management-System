...
var FormControlLabel = React3.forwardRef(function FormControlLabel2(inProps, ref) {
  ...
  return (0, import_jsx_runtime2.jsxs)(FormControlLabelRoot, {
    ...
    ref,
    ...other,
    children: [React3.cloneElement(control, controlProps), required ? (0, import_jsx_runtime2.jsxs)("div", {
...
var indeterminate1Keyframe = import_react.keyframes`
  0% {
    left: -35%;
    right: 100%;
  }
...
`;
var indeterminate1Animation = typeof indeterminate1Keyframe !== "string" ? import_react.css`
        animation: ${indeterminate1Keyframe} 2.1s cubic-bezier(0.65, 0.815, 0.735, 0.395) infinite;
      ` : null;
var indeterminate2Keyframe = import_react.keyframes`
  0% {
    left: -200%;
    right: 100%;
  }
...
`;
var indeterminate2Animation = typeof indeterminate2Keyframe !== "string" ? import_react.css`
        animation: ${indeterminate2Keyframe} 2.1s cubic-bezier(0.165, 0.84, 0.44, 1) 1.15s infinite;
      ` : null;
var bufferKeyframe = import_react.keyframes`
  0% {
    opacity: 1;
...
`;
var bufferAnimation = typeof bufferKeyframe !== "string" ? import_react.css`
...
var pulseKeyframe = import_react.keyframes`
  0% {
    opacity: 1;
  }
...
`;
var waveKeyframe = import_react.keyframes`
  0% {
...
`;
var pulseAnimation = typeof pulseKeyframe !== "string" ? import_react.css`
        animation: ${pulseKeyframe} 2s ease-in-out 0.5s infinite;
      ` : null;
var waveAnimation = typeof waveKeyframe !== "string" ? import_react.css`
        &::after {
...
var Tooltip = React8.forwardRef(function Tooltip2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React8.Fragment, {
    children: [React8.cloneElement(children, childrenProps), (0, import_jsx_runtime7.jsx)(PopperSlot, {
      ...
      children: ({
        ...
        children: (0, import_jsx_runtime7.jsxs)(TooltipSlot, {
          ...tooltipSlotProps,
          children: [title, arrow ? (0, import_jsx_runtime7.jsx)(ArrowSlot, {
            ...arrowSlotProps
          }) : null]
        })
      })
...
var Tab = React10.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React10.isValidElement(iconProp) ? React10.cloneElement(iconProp, {
  ...
  return (0, import_jsx_runtime9.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime9.jsxs)(React10.Fragment, {
      children: [icon, label]
...
var TablePaginationActions = React19.forwardRef(function TablePaginationActions2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTablePaginationActions"
  });
  ...
  return (0, import_jsx_runtime16.jsxs)(TablePaginationActionsRoot, {
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
var TabScrollButton = React21.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
  ...
  return (0, import_jsx_runtime18.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime18.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime18.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React22.useRef();
...
var Tabs = React23.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React23.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React23.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React23.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React23.useState(false);
  const [scrollerStyle, setScrollerStyle] = React23.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React23.useRef(null);
  const tabListRef = React23.useRef(null);
  const externalForwardedProps = {
    slots,
    slotProps: {
  ...
  const handleScrollbarSizeChange = React23.useCallback((scrollbarWidth) => {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime20.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime20.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime20.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime20.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  const children = React23.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime20.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime20.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
...
var ToggleButton = React26.forwardRef(function ToggleButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime21.jsx)(ToggleButtonRoot, {
...
//# sourceMappingURL=chunk-V4M57P5A.js.map
